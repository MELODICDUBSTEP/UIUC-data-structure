...
void LinkedList<T>::insertOrdered(const T& newData) {
  ...
  if(head_ == nullptr)
  {
    head_ = tail_ = new Node(newData);
    return;
  }
  Node* iterator = head_;
  while(iterator != nullptr && iterator -> data <= newData)
  {
    iterator = iterator -> next;
  }
  if(iterator == nullptr)
  {
    tail_ -> next = new Node(newData);
  ...
  if(iterator == head_)
  {
    head_ -> prev = new Node(newData);
    head_ -> prev -> next = head_;
    head_ = head_ -> prev;
    return;
  }
  Node* temp = iterator -> prev;
  iterator -> prev = new Node(newData);
  iterator -> prev -> next = iterator;
  temp -> next = iterator -> prev;
  iterator -> prev -> prev = temp;
  // -----------------------------------------------------------
  // TODO: Your code here!
  // -----------------------------------------------------------
...
LinkedList<T> LinkedList<T>::merge(const LinkedList<T>& other) const {
  ...
  const Node* left = head_;
  const Node* right = other.head_;
  while(left != nullptr && right != nullptr)
  {
    if(left -> data < right -> data)
    {
      ...
      {
        merged.head_ = merged.tail_ = new Node(left -> data);
      }
      else
      {
        merged.tail_ -> next = new Node(left -> data);
        merged.tail_ -> next -> prev = merged.tail_;
        merged.tail_ = merged.tail_ -> next;
      }
    ...
    else
    {
      ...
      if(merged.head_ == nullptr)
      {
        merged.head_ = merged.tail_ = new Node(right -> data);
      }
      else
      {
        merged.tail_ -> next = new Node(right -> data);
        merged.tail_ -> next -> prev = merged.tail_;
        merged.tail_ = merged.tail_ -> next;
      }
      right = right -> next;
